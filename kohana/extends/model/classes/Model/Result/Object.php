...
/**
 * result object
 * @copyright vms Business_Client_Result_Object
 */
class Model_Result_Object extends Model_Result implements Countable, Iterator, SeekableIterator, ArrayAccess {
	...
	final public function offsetSet($offset, $value) {
		throw new Model_Result_Exception('Results are read-only');
	}
	
	final public function offsetUnset($offset) {
		throw new Model_Result_Exception('Database results are read-only');
	}
